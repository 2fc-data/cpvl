...
import { PilotTakeOffDetails, loader as pilotTakeOffDetailsLoader } from "./pages/dashboard/pilotTakeOffDetails";
    ...
    children: [
      ...
      { path: "statute", element: <Statute /> },
      {
        ...
        children: [
          ...
          { 
            path: ":id", element: <PilotTakeOffDetails />,
            loader: pilotTakeOffDetailsLoader,
           },
        ],
      },
    ],
